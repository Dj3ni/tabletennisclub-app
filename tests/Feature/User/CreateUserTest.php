...
describe('CreateUser', function () {
    ...
    it('create method returning expected view and data', function (): void {
        ...
        $response
            ->assertOk()
            ->assertViewIs('clubAdmin.users.create')
            ->assertViewHasAll([
    ...
    it('email is not already taken', function (): void {
        $admin = $this->createFakeAdmin();
    ...
    it('force list service is injected', function (): void {
    ...
    it('licence is not already taken', function (): void {
        $admin = $this->createFakeAdmin();
    ...
    it('member cannot create new member', function (): void {
    ...
    it('new member creation positive case', function (): void {
    ...
    it('new member creation with invalid paramaters returns errors in the session', function (): void {
        $admin = $this->createFakeAdmin();
    ...
    it('new member is competitor with valid ranking and licence', function (): void {
        $admin = $this->createFakeAdmin();
    ...
    it('new member is competitor without ranking and licence', function (): void {
        $admin = $this->createFakeAdmin();
    ...
    it('new member created is automatically linked to the club', function (): void {
        $user = User::factory()->create();
        $club = Club::firstWhere('licence', config('app.club_licence'));
        expect($user->club_id)->toEqual($club->id);
    });
    it('ranking is invalid', function (): void {
        $admin = $this->createFakeAdmin();
